...
END_TMPL
            ...
            $slug = <<END_TMPL;
<link rel="stylesheet" type="text/css" href="<mt:var name="static_uri">plugins/MaxImageWidth/app.css" />
<link rel="stylesheet" type="text/css" href="<mt:var name="static_uri">jquery/themes/flora/flora.all.css" />
...
<script type="text/javascript" src="<mt:var name="static_uri">jquery/ui/ui.slider.js"></script>
END_TMPL
        }
...
<script type="text/javascript">
    ...
    jQuery(document).ready( function() {
        if (full_width > max_width) {
             jQuery('#create_thumbnail').replaceWith('<input type="hidden" name="thumb" id="create_thumbnail" value="1"$mt />');
        }
        ...
        <div id="create_thumbnail_cb">
          ...
          <label><__trans_section component="MaxImageWidth"><__trans phrase='Use thumbnail?'></__trans_section></label>
        </div>
        <div id="w-h">
